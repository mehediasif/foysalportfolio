...
import { FcLeft, FcVoicePresentation, FcHome, FcAddressBook, FcViewDetails, FcServices, FcDiploma1, FcEngineering } from "react-icons/fc";
    ...
    return(
        <aside className="bg-slate-700 text-white p-1">
            <nav role='navigation' className="flex flex-col gap-1">
                <div className={`bg-primary h-auto p-5 text-ternary pt-8 relative duration-500 ${open ? 'w-72' : 'w-20'}`}>
